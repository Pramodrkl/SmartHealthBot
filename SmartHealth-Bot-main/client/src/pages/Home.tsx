        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="healthcare-card max-w-md w-full animate-scale-in">
            ...
            <div className="text-center mb-6">
              ...
              <h4 className="text-xl font-heading font-bold text-healthcare-neutral-900 mb-2">Pramod Yadav</h4>
            ...
            <div className="flex justify-center space-x-4">
              <a 
                href="https://www.linkedin.com/in/pramod-yadav-418695268/" 
                target="_blank" 
              ...
              <a 
                href="https://github.com/Pramodrkl" 
                target="_blank" 
                rel="noopener noreferrer"
